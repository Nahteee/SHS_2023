 ...
 * @author User
 */
public class UI_Admin_Manage_Roomtype extends javax.swing.JFrame {

    /**
     * Creates new form UI_Admin_Manage_Roomtype
     */
    public UI_Admin_Manage_Roomtype() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/java/SHS/UI/Imgs/Roomtype (Selected).png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_Admin_Manage_Roomtype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_Admin_Manage_Roomtype().setVisible(true);
            }
        });
    }
